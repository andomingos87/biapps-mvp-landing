    ...
    <header className={`sticky top-0 z-50 w-full transition-all duration-300 ${isScrolled ? 'bg-white/95 backdrop-blur-sm shadow-md' : 'bg-white'}`}>
      <div className="container-custom flex justify-between items-center h-20">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Button className="bg-primary hover:bg-primary/90 text-white shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30 transition-all">Contato</Button>
        </nav>

        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 right-0 bg-white shadow-xl z-50 border-t animate-fade-in">
            <div className="flex flex-col p-6 space-y-6">
              <a 
                href="#about" 
                className="p-2 text-lg text-gray-700 hover:text-primary font-medium transition-colors border-b border-gray-100 pb-4"
