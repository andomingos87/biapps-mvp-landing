      ...
      <div className="container-custom grid md:grid-cols-2 gap-12 items-center">
        <div className="order-2 md:order-1 animate-fade-in">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Desenvolvemos MVPs Web <span className="whitespace-nowrap">em até <span className="text-secondary flex items-center inline-flex"><Zap className="h-8 w-8 mr-1 inline" /> 4 semanas</span></span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <Button className="bg-primary hover:bg-primary/90 text-white px-6 py-6 text-lg shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 transition-all">
              Iniciar projeto
          ...
          <div className="relative animate-fade-in">
            ...
            <div className="absolute -bottom-5 -right-5 bg-white p-4 rounded-lg shadow-xl z-20">
              <div className="flex items-center space-x-2">
                ...
                <p className="font-medium">Atualizado em tempo real</p>
              </div>
            </div>
          </div>
        </div>
